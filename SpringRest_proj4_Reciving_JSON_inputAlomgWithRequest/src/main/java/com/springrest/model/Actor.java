...
public class Actor {
	...
	public String toString() {
		return "Actor [id=" + id + ", name=" + name + ", address=" + address + ", fees=" + fees + ", remunatation="
				+ remunatation + ", favColor=" + Arrays.toString(favColor) + ", friend=" + friend + ", phone=" + phone
				+ ", idDetails=" + idDetails + ", vehicle=" + vehicle + "]";
	}
	private Integer id;
	private String name;
